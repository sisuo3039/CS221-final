...
class Stock:
    ...
    def step(self,s,a,index):
        reward=self.calcReward(s[0],s[1],float(self.closePrice(self.company,index)))
    ...
    def run(self, agent):
        ...
        while True:
            ...
            s_ = numpy.array(s_)
            self.date=self.date+ self.stepTimeDelta
            index+=1
...
needrepaly=False
replayFile='stock_SAP_episode1441_2017-12-04.h5'
